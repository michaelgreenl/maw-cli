...
declare const commandDefinitions: readonly [CommandDefinition<"init">, CommandDefinition<"dev">, CommandDefinition<"ov:init">, CommandDefinition<"ov:index">];
export declare const COMMAND_NAMES: ("dev" | "init" | "ov:index" | "ov:init")[];
